...
Public Class KzFile
    ...
    Public Shared Function GetOpenFiles() As String()
        ...
        With ofd
            If Directory.Exists(My.Settings.FileInitialDirectory) Then
                .InitialDirectory = My.Settings.FileInitialDirectory
            Else
            ...
            .ShowReadOnly = True
            .Multiselect = True
            .Filter = My.Settings.TextFileFilter

            If .ShowDialog = DialogResult.OK Then
                My.Settings.FileInitialDirectory = Path.GetDirectoryName(ofd.FileNames(0))
                Return .FileNames
            Else
                Return {} ' Nothing
            End If
    ...
    Public Shared Function GetSaveFile() As String
        ...
        With sfd
            ...
            If .ShowDialog = DialogResult.OK Then
                My.Settings.FileInitialDirectory = Path.GetDirectoryName(.FileName)
                Return .FileName
            Else
                Return Nothing
            End If
